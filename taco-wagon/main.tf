...
resource "aws_instance" "web" {
  ...
  lifecycle {
    precondition {
      ...
      error_message = "The desired architecture is x86_64. Provided value is ${data.aws_ami.amazon_linux.architecture}"
    }
    ...
    postcondition {
      ...
      error_message = "The EC2 instance must have a public IP assigned."
    }
  }
}
